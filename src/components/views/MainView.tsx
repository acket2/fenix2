            ...
            {user.role === 'admin' && (
              <div className="flex gap-2 mb-5">
                <input 
                  ...
                  className="flex-1 bg-slate-900/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-sm text-white focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 outline-none transition-all placeholder-slate-500"
                />
                <button 
                  onClick={handleAddQuickObject}
                  className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-4 rounded-xl flex items-center gap-2 hover:from-blue-700 hover:to-cyan-700 transition-all font-semibold text-sm shadow-lg shadow-cyan-900/20"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex gap-2">
                ...
                <button 
                   ...
                   className="bg-slate-800 text-slate-300 px-4 py-3 rounded-xl hover:bg-slate-700 hover:text-white border border-slate-700 transition-colors flex items-center justify-center"
                   title="Прикрепить картинку"
                >
                  <ImageIcon className="w-5 h-5" />
                </button>
                <button type="submit" className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl text-sm font-bold uppercase tracking-wider hover:from-purple-500 hover:to-blue-500 transition-all shadow-lg shadow-purple-900/20 whitespace-nowrap">
                  Опубликовать
                </button>
              </div>
            </div>
